...
const BarbershopItem = ({ barbershop }: BarbershopItemProps) => {
  return (
    <Link
      ...
      className="relative block min-h-[200px] min-w-[290px] rounded-xl"
    >
      <div className="absolute top-0 left-0 z-10 h-full rounded-lg bg-linear-to-t from-black to-transparent" />
      <Image
